...
describe('Content.vue', () => {
  ...
  describe('썸네일', () => {
    test('썸네일이 있으면 보여주는가', () => {
      ...
      expect(wrapper.find('[data-test="content-thumbnail"]').exists()).toBeTruthy();
    })
    ...
    test('썸네일이 없으면 보여주지 않는가', () => {
      ...
      expect(wrapper.find('[data-test="content-thumbnail"]').exists()).toBeFalsy();
    })
  })
  ...
  test('설명을 보여주는가', () => {
    ...
    expect(wrapper.find('[data-test="content-description"]').exists()).toBeTruthy();
    expect(wrapper.find('[data-test="content-description"]').text()).toBe('test');
  })
  test('작성자를 보여주는가', () => {
    const wrapper = mount(Content, {
      propsData: {
    ...
    expect(wrapper.find('[data-test="content-author"]').text()).toContain('test');
  })
  test('좋아요수를 보여주는가', () => {
    const wrapper = mount(Content, {
      propsData: {
